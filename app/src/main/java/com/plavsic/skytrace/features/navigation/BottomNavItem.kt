...
sealed class BottomNavItem(val route: String, val title: String, @DrawableRes val selectedIcon: Int,@DrawableRes val unselectedIcon:Int) {
    ...
    data object Aircraft : BottomNavItem(route = "aircraft", title = "Aircrafts", selectedIcon =R.drawable.selected_aircraft, unselectedIcon = R.drawable.unselected_aircraft)
}